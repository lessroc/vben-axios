...
- Extract the axios request library encapsulated by [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) and integrate it into the [vitesse](https://github.com/antfu/vitesse) template for easy use in other projects
